...
Let's create new directory and file under `src/shared/groceries.gleam` and define our 
core types there. The `_to_json` and `_decoder` functions are largely auto-generated 
by using the respective code actions:
