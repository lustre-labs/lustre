...
pub fn script() -> Element(message) {
  html.script(
    ...
    // <<INJECT RUNTIME>>
    "function De(i){return i.replaceAll(/[><&\"']/g,e=>{switch(e){case\">\":return\"&gt;\";case\"<\":return\"&lt;\";case\"'\":return\"&#39;\";case\"&\":return\"&amp;\";case'\"':return\"&quot;\";default:return e}})}function qe(i){return De(i)}function q(i){return qe(i)}var l=class{withFields(e){let t=Object.keys(this).map(n=>n in e?e[n]:this[n]);return new this.constructor(...t)}},S=class{static fromArray(e,t){return b(e,t)}[Symbol.iterator](){return new ce(this)}toArray(){return[...this]}atLeastLength(e){let t=this;for(;e-- >0&&t;)t=t.tail;return t!==void 0}hasLength(e){let t=this;for(;e-- >0&&t;)t=t.tail;return e===-1&&t instanceof a}countLength(){let e=this,t=0;for(;e;)e=e.tail,t++;return t-1}};function b(i,e){let t=e||m;for(let n=i.length-1;n>=0;--n)t=new P(i[n],t);return t}var ce=class{#r;constructor(e){this.#r=e}next(){if(this.#r instanceof a)return{done:!0};{let{head:e,tail:t}=this.#r;return this.#r=t,{value:e,done:!1}}}},a=class extends S{},m=new a;var P=class extends S{constructor(e,t){super(),this.head=e,this.tail=t}};var le=i=>i.head,R=i=>i.tail;var M=class extends l{},H=new M;var A=class extends l{},V=new A;var ue=class extends l{},G=new ue;var W=class extends l{},ae=new W;var cn=5,gr=(1<<cn)-1,br=Symbol(),wr=Symbol();var pe=class extends l{},Dr=new pe,de=class extends l{},qr=new de;var Xe=[\" \",\"	\",`\\n`,\"\\v\",\"\\f\",\"\\r\",\"\\x85\",\"\\u2028\",\"\\u2029\"].join(\"\"),$i=new RegExp(`^[${Xe}]*`),xi=new RegExp(`[${Xe}]*$`);var _e=class extends l{},Gi=new _e;var me=class extends l{},_s=new me,$e=class extends l{},ms=new $e;var xe=class extends l{},ro=new xe;var ht=0,_t=1,mt=2,$t=0;var ye=2;var ee=0,te=1,ke=2,xt=3,L=4,gt=5;var bt=0,wt=1,yt=2,kt=3,vt=4,Et=5,jt=6;var ve=class extends l{},Fo=new ve;var St=\"\\r\",Mt=\"	\";var g=(i,e)=>{if(Array.isArray(i))for(let t=0;t<i.length;t++)e(i[t]);else if(i)for(i;R(i);i=R(i))e(le(i))};var Ee=\"http://www.w3.org/1999/xhtml\";var Bt=!!globalThis.HTMLElement?.prototype?.moveBefore;var Pn=globalThis.setTimeout,je=globalThis.clearTimeout,Rn=(i,e)=>globalThis.document.createElementNS(i,e),Ot=i=>globalThis.document.createTextNode(i),Tt=i=>globalThis.document.createComment(i),Fn=()=>globalThis.document.createDocumentFragment(),v=(i,e,t)=>i.insertBefore(e,t),zt=Bt?(i,e,t)=>i.moveBefore(e,t):v,It=(i,e)=>i.removeChild(e),Hn=(i,e)=>i.getAttribute(e),Nt=(i,e,t)=>i.setAttribute(e,t),Vn=(i,e)=>i.removeAttribute(e),Gn=(i,e,t,n)=>i.addEventListener(e,t,n),Lt=(i,e,t)=>i.removeEventListener(e,t),Wn=(i,e)=>i.innerHTML=e,Jn=(i,e)=>i.data=e,_=Symbol(\"lustre\"),Se=class{constructor(e,t,n,r){this.kind=e,this.key=r,this.parent=t,this.children=[],this.node=n,this.endNode=null,this.handlers=new Map,this.throttles=new Map,this.debouncers=new Map}get isVirtual(){return this.kind===ee||this.kind===L}get parentNode(){return this.isVirtual?this.node.parentNode:this.node}};var U=(i,e,t,n,r)=>{let o=new Se(i,e,t,r);return t[_]=o,e?.children.splice(n,0,o),o},Qn=i=>{let e=\"\";for(let t=i[_];t.parent;t=t.parent){let n=t.parent&&t.parent.kind===L?St:Mt;if(t.key)e=`${n}${t.key}${e}`;else{let r=t.parent.children.indexOf(t);e=`${n}${r}${e}`}}return e.slice(1)},D=class{#r=null;#e;#t;#i=!1;constructor(e,t,n,{debug:r=!1}={}){this.#r=e,this.#e=t,this.#t=n,this.#i=r}mount(e){U(te,null,this.#r,0,null),this.#m(this.#r,null,this.#r[_],0,e)}push(e,t=null){this.#n=t,this.#s.push({node:this.#r[_],patch:e}),this.#l()}#n;#s=[];#l(){let e=this.#s;for(;e.length;){let{node:t,patch:n}=e.pop(),{path:r,changes:o,removed:s,children:c}=n;g(r,f=>{t=t.children[f]});let{children:u}=t;g(o,f=>this.#c(t,f)),s&&this.#h(t,u.length-s,s),g(c,f=>{let x=u[f.index|0];this.#s.push({node:x,patch:f})})}}#c(e,t){switch(t.kind){case bt:this.#b(e,t);break;case wt:this.#y(e,t);break;case yt:this.#g(e,t);break;case kt:this.#o(e,t);break;case vt:this.#x(e,t);break;case Et:this.#u(e,t);break;case jt:this.#a(e,t);break}}#a(e,{children:t,before:n}){let r=Fn(),o=this.#f(e,n);this.#w(r,null,e,n|0,t),v(e.parentNode,r,o)}#u(e,{index:t,with:n}){this.#h(e,t|0,1);let r=this.#f(e,t);this.#m(e.parentNode,r,e,t|0,n)}#f(e,t){t=t|0;let{children:n}=e,r=n.length;if(t<r)return n[t].node;if(e.endNode)return e.endNode;if(!e.isVirtual)return null;for(;e.isVirtual&&e.children.length;){if(e.endNode)return e.endNode.nextSibling;e=e.children[e.children.length-1]}return e.node.nextSibling}#o(e,{key:t,before:n}){n=n|0;let{children:r,parentNode:o}=e,s=r[n].node,c=r[n];for(let u=n+1;u<r.length;++u){let f=r[u];if(r[u]=c,c=f,f.key===t){r[n]=f;break}}this.#p(o,c,s)}#d(e,t,n){for(let r=0;r<t.length;++r)this.#p(e,t[r],n)}#p(e,t,n){zt(e,t.node,n),t.isVirtual&&this.#d(e,t.children,n),t.endNode&&zt(e,t.endNode,n)}#x(e,{index:t}){this.#h(e,t,1)}#h(e,t,n){let{children:r,parentNode:o}=e,s=r.splice(t,n);for(let c=0;c<s.length;++c){let u=s[c],{node:f,endNode:x,isVirtual:E,children:d}=u;It(o,f),x&&It(o,x),this.#_(u),E&&s.push(...d)}}#_(e){let{debouncers:t,children:n}=e;for(let{timeout:r}of t.values())r&&je(r);t.clear(),g(n,r=>this.#_(r))}#g({node:e,handlers:t,throttles:n,debouncers:r},{added:o,removed:s}){g(s,({name:c})=>{t.delete(c)?(Lt(e,c,Ce),this.#$(n,c,0),this.#$(r,c,0)):(Vn(e,c),Dt[c]?.removed?.(e,c))}),g(o,c=>this.#E(e,c))}#b({node:e},{content:t}){Jn(e,t??\"\")}#y({node:e},{inner_html:t}){Wn(e,t??\"\")}#w(e,t,n,r,o){g(o,s=>this.#m(e,t,n,r++,s))}#m(e,t,n,r,o){switch(o.kind){case te:{let s=this.#k(n,r,o);this.#w(s,null,s[_],0,o.children),v(e,s,t);break}case ke:{let s=this.#j(n,r,o);v(e,s,t);break}case ee:{let s=\"lustre:fragment\",c=this.#v(s,n,r,o);v(e,c,t),this.#w(e,t,c[_],0,o.children),this.#i&&(c[_].endNode=Tt(` /${s} `),v(e,c[_].endNode,t));break}case xt:{let s=this.#k(n,r,o);this.#y({node:s},o),v(e,s,t);break}case L:{let s=this.#v(\"lustre:map\",n,r,o);v(e,s,t),this.#m(e,t,s[_],0,o.child);break}case gt:{let s=this.#n?.get(o.view)??o.view();this.#m(e,t,n,r,s);break}}}#k(e,t,{kind:n,key:r,tag:o,namespace:s,attributes:c}){let u=Rn(s||Ee,o);return U(n,e,u,t,r),this.#i&&r&&Nt(u,\"data-lustre-key\",r),g(c,f=>this.#E(u,f)),u}#j(e,t,{kind:n,key:r,content:o}){let s=Ot(o??\"\");return U(n,e,s,t,r),s}#v(e,t,n,{kind:r,key:o}){let s=this.#i?Tt(Kn(e,o)):Ot(\"\");return U(r,t,s,n,o),s}#E(e,t){let{debouncers:n,handlers:r,throttles:o}=e[_],{kind:s,name:c,value:u,prevent_default:f,debounce:x,throttle:E}=t;switch(s){case ht:{let d=u??\"\";if(c===\"virtual:defaultValue\"){e.defaultValue=d;return}else if(c===\"virtual:defaultChecked\"){e.defaultChecked=!0;return}else if(c===\"virtual:defaultSelected\"){e.defaultSelected=!0;return}d!==Hn(e,c)&&Nt(e,c,d),Dt[c]?.added?.(e,d);break}case _t:e[c]=u;break;case mt:{r.has(c)&&Lt(e,c,Ce);let d=f.kind===$t;Gn(e,c,Ce,{passive:d}),this.#$(o,c,E),this.#$(n,c,x),r.set(c,j=>this.#C(t,j));break}}}#$(e,t,n){let r=e.get(t);if(n>0)r?r.delay=n:e.set(t,{delay:n});else if(r){let{timeout:o}=r;o&&je(o),e.delete(t)}}#C(e,t){let{currentTarget:n,type:r}=t,{debouncers:o,throttles:s}=n[_],c=Qn(n),{prevent_default:u,stop_propagation:f,include:x}=e;u.kind===ye&&t.preventDefault(),f.kind===ye&&t.stopPropagation(),t instanceof window.SubmitEvent&&(t.detail??={},t.detail.formData=[...new FormData(t.target,t.submitter).entries()]);let E=this.#e(t,c,r,x),d=s.get(r);if(d){let Ue=Date.now(),nn=d.last||0;Ue>nn+d.delay&&(d.last=Ue,d.lastEvent=t,this.#t(t,E))}let j=o.get(r);j&&(je(j.timeout),j.timeout=Pn(()=>{t!==s.get(r)?.lastEvent&&this.#t(t,E)},j.delay)),!d&&!j&&this.#t(t,E)}},Kn=(i,e)=>e?` ${i} key=\"${q(e)}\" `:` ${i} `,Ce=i=>{let{currentTarget:e,type:t}=i;e[_].handlers.get(t)(i)},Ut=i=>({added(e){e[i]=!0},removed(e){e[i]=!1}}),Xn=i=>({added(e,t){e[i]=t}}),Dt={checked:Ut(\"checked\"),selected:Ut(\"selected\"),value:Xn(\"value\"),autofocus:{added(i){queueMicrotask(()=>{i.focus?.()})}},autoplay:{added(i){try{i.play?.()}catch(e){console.error(e)}}}};var Me=class extends l{},kl=new Me,Ae=class extends l{},vl=new Ae,Be=class extends l{},El=new Be,Oe=class extends l{},jl=new Oe,Te=class extends l{},Cl=new Te;var Vt=new WeakMap;async function Gt(i){let e=[];for(let n of globalThis.document.querySelectorAll(\"link[rel=stylesheet], style\"))n.sheet||e.push(new Promise((r,o)=>{n.addEventListener(\"load\",r),n.addEventListener(\"error\",o)}));if(await Promise.allSettled(e),!i.host.isConnected)return[];i.adoptedStyleSheets=i.host.getRootNode().adoptedStyleSheets;let t=[];for(let n of globalThis.document.styleSheets)try{i.adoptedStyleSheets.push(n)}catch{try{let r=Vt.get(n);if(!r){r=new CSSStyleSheet;for(let o of n.cssRules)r.insertRule(o.cssText,r.cssRules.length);Vt.set(n,r)}i.adoptedStyleSheets.push(r)}catch{let r=n.ownerNode.cloneNode();i.prepend(r),t.push(r)}}return t}var re=class extends Event{constructor(e,t,n){super(\"context-request\",{bubbles:!0,composed:!0}),this.context=e,this.callback=t,this.subscribe=n}},ie=class extends CustomEvent{isLustreEvent=!0;constructor(e,t){super(e,{detail:t,bubbles:!0,composed:!0})}};var Wt=0,Jt=1,Qt=2,Kt=3,Xt=4,Yt=5,se=0,Zt=1,en=2,oe=3,tn=4;var ze=class extends HTMLElement{static get observedAttributes(){return[\"route\",\"method\",\"csrf-token\",\"provides\"]}#r;#e=\"ws\";#t=null;#i=null;#n=null;#s=[];#l;#c=new Set;#a=new Set;#u=!1;#f=[];#o=new Map;#d=new Set;#p=new Map;#x=new MutationObserver(e=>{let t=[];for(let n of e){if(n.type!==\"attributes\")continue;let r=n.attributeName;(!this.#u||this.#c.has(r))&&t.push([r,this.getAttribute(r)])}if(t.length===1){let[n,r]=t[0];this.#n?.send({kind:se,name:n,value:r})}else t.length?this.#n?.send({kind:oe,messages:t.map(([n,r])=>({kind:se,name:n,value:r}))}):this.#f.push(...t)});constructor(){super(),this.internals=this.attachInternals(),this.#x.observe(this,{attributes:!0}),this.addEventListener(\"context-request\",e=>{if(!e.context||!e.callback||!this.#o.has(e.context))return;e.stopImmediatePropagation();let t=this.#o.get(e.context);if(e.subscribe){let n=()=>{t.subscribers=t.subscribers.filter(r=>r!==e.callback)};t.subscribers.push([e.callback,n]),e.callback(t.value,n)}else e.callback(t.value)})}connectedCallback(){for(let e of this.attributes)this.#f.push([e.name,e.value])}attributeChangedCallback(e,t,n){switch(e){case(t!==n&&\"route\"):{this.#t=new URL(n,location.href),this.#i=this.#h(),this.#t.searchParams.set(\"csrf-token\",this.#i),this.#_();return}case\"method\":{let r=n.toLowerCase();if(r==this.#e)return;[\"ws\",\"sse\",\"polling\"].includes(r)&&(this.#e=r,this.#e==\"ws\"&&(this.#t.protocol==\"https:\"&&(this.#t.protocol=\"wss:\"),this.#t.protocol==\"http:\"&&(this.#t.protocol=\"ws:\")),this.#_());return}case\"csrf-token\":{t!==n&&this.#u&&this.#n?.close(),this.#i=this.#h(),this.#t&&this.#t.searchParams.set(\"csrf-token\",this.#i),this.#u&&this.#_();return}case(t!==n&&\"provides\"):{let r=this.#d,o=new Set(n.split(\" \"));for(let s of r){let{subscribers:c}=this.#o.get(s);c?.length===0&&!o.has(s)&&this.#o.delete(s)}for(let s of o)this.#o.has(s)||this.provide(s,null);this.#d=o;return}}}async messageReceivedCallback(e){switch(e.kind){case Wt:{for(this.#r??=this.attachShadow({mode:e.open_shadow_root?\"open\":\"closed\"});this.#r.firstChild;)this.#r.firstChild.remove();let t=(s,c,u,f)=>{let x=this.#b(s,f??[]);return{kind:Zt,path:c,name:u,event:x}},n=(s,c)=>{this.#n?.send(c)};this.#l=new D(this.#r,t,n),this.#c=new Set(e.observed_attributes);let o=this.#f.filter(([s])=>this.#c.has(s)).map(([s,c])=>({kind:se,name:s,value:c}));this.#f=[],this.#a=new Set(e.observed_properties);for(let s of this.#a)Object.defineProperty(this,s,{get(){return this[`_${s}`]},set(c){this[`_${s}`]=c,this.#n?.send({kind:en,name:s,value:c})}});for(let[s,c]of Object.entries(e.provided_contexts))this.provide(s,c);for(let s of[...new Set(e.requested_contexts)])this.subscribe(s);o.length&&this.#n.send({kind:oe,messages:o}),e.will_adopt_styles&&await this.#g(),this.#l.mount(e.vdom),this.dispatchEvent(new CustomEvent(\"lustre:mount\"));break}case Jt:{this.#l.push(e.patch);break}case Qt:{this.dispatchEvent(new ie(e.name,e.data));break}case Kt:{this.provide(e.key,e.value);break}case Xt:{this.subscribe(e.key);break}case Yt:{this.unsubscribe(e.key);break}}}disconnectedCallback(){this.unsubscribeAll();for(let[e,t]of this.#o)this.#d.has(e)||this.#o.delete(e);this.#n&&(this.#n.close(),this.#n=null)}provide(e,t){if(!this.#o.has(e))this.#o.set(e,{value:t,subscribers:[]});else{let n=this.#o.get(e);n.value=t;for(let r=n.subscribers.length-1;r>=0;r--){let[o,s]=n.subscribers[r];if(!o){n.subscribers.splice(r,1);continue}o(t,s)}}}subscribe(e){e&&(this.#p.get(e)?.(),this.dispatchEvent(new re(e,(t,n)=>{this.#n?.send({kind:tn,key:e,value:t}),this.#p.get(e)?.(),this.#p.set(n)})))}unsubscribe(e){this.#p.get(e)?.(),this.#p.delete(e)}unsubscribeAll(){for(let[e,t]of this.#p)t?.();this.#p.clear()}#h(){return this.hasAttribute(\"csrf-token\")?this.getAttribute(\"csrf-token\")||null:document.querySelector('meta[name=\"csrf-token\"]')?.getAttribute(\"content\")||null}#_(){if(!this.#t||!this.#e)return;this.#n&&this.#n.close();let r={onConnect:()=>{this.#u=!0,this.dispatchEvent(new CustomEvent(\"lustre:connect\"),{detail:{route:this.#t,method:this.#e}})},onMessage:o=>{this.messageReceivedCallback(o)},onClose:()=>{this.#u=!1;for(let[o,{subscribers:s}]of this.#o)!this.#d.has(o)&&s?.length===0&&this.#o.delete(o);this.dispatchEvent(new CustomEvent(\"lustre:close\",{detail:{route:this.#t,method:this.#e}}))},csrfToken:this.#i};switch(this.#e){case\"ws\":this.#n=new Ie(this.#t,r);break;case\"sse\":this.#n=new Ne(this.#t,r);break;case\"polling\":this.#n=new Le(this.#t,r);break}}async#g(){for(this.shadowRoot.adoptedStyleSheets=[];this.#s.length;)this.#s.pop().remove();this.#s=await Gt(this.#r)}#b(e,t=[]){let n={};e.isLustreEvent&&t.push(\"detail\"),(e.type===\"input\"||e.type===\"change\")&&(e.target.type===\"checkbox\"?t.push(\"target.checked\"):t.push(\"target.value\")),(e.type===\"keydown\"||e.type===\"keyup\"||e.type===\"keypress\")&&t.push(\"key\"),e.type===\"submit\"&&t.push(\"detail.formData\");for(let r of t){let o=r.split(\".\");for(let s=0,c=e,u=n;s<o.length;s++){if(s===o.length-1){u[o[s]]=c[o[s]];break}u=u[o[s]]??={},c=c[o[s]]}}return n}},Ie=class{#r;#e;#t=!1;#i=[];#n=!0;#s=500;#l=1e4;#c;#a;#u;constructor(e,{onConnect:t,onMessage:n,onClose:r}){this.#r=e,this.#c=t,this.#a=n,this.#u=r,this.#f()}#f(){this.#e=new WebSocket(this.#r),this.#n=!0,this.#i=[],this.#e.onopen=()=>{this.#s=500,this.#c()},this.#e.onmessage=({data:e})=>{try{this.#a(JSON.parse(e))}finally{this.#i.length?this.#e.send(JSON.stringify({kind:oe,messages:this.#i})):this.#t=!1,this.#i=[]}},this.#e.onclose=e=>{this.#u(),e.code!==1e3&&this.#n&&this.#o()}}#o(){let e=()=>{this.#n&&(this.#f(),this.#s=Math.min(this.#s*2,this.#l))};if(document.hidden){let t=()=>{!document.hidden&&this.#n&&(document.removeEventListener(\"visibilitychange\",t),e())};document.addEventListener(\"visibilitychange\",t)}else setTimeout(e,this.#s)}send(e){if(!(!this.#e||this.#e.readyState!==WebSocket.OPEN))if(this.#t){this.#i.push(e);return}else this.#e.send(JSON.stringify(e)),this.#t=!0}close(){this.#n=!1,this.#e.close(1e3),this.#e=null}},Ne=class{#r;#e;#t=!0;#i=500;#n=1e4;#s;#l;#c;constructor(e,{onConnect:t,onMessage:n,onClose:r}){this.#r=e,this.#s=t,this.#l=n,this.#c=r,this.#a()}#a(){this.#e=new EventSource(this.#r),this.#i=500,this.#t=!0,this.#e.onopen=()=>{this.#s()},this.#e.onmessage=({data:e})=>{try{this.#l(JSON.parse(e))}catch{}},this.#e.onerror=()=>{this.#e.close(),this.#c(),this.#t&&this.#u()}}#u(){let e=()=>{this.#t&&(this.#a(),this.#i=Math.min(this.#i*2,this.#n))};if(document.hidden){let t=()=>{!document.hidden&&this.#t&&(document.removeEventListener(\"visibilitychange\",t),e())};document.addEventListener(\"visibilitychange\",t)}else setTimeout(e,this.#i)}send(e){}close(){this.#t=!1,this.#e.close(),this.#c()}},Le=class{#r;#e;#t;#i;#n;#s;#l;constructor(e,{onConnect:t,onMessage:n,onClose:r,csrfToken:o,interval:s}){this.#r=e,this.#e=o,this.#t=s??5e3,this.#n=t,this.#s=n,this.#l=r,this.#c().finally(()=>{this.#n(),this.#i=setInterval(()=>this.#c(),this.#t)})}async send(e){}close(){clearInterval(this.#i),this.#l()}#c(){let e=Object.assign({},this.#e&&{\"x-csrf-token\":this.#e});return fetch(this.#r,{headers:e}).then(t=>t.json()).then(this.#s).catch(console.error)}};customElements.define(\"lustre-server-component\",ze);export{ze as ServerComponent};",
  )
}
...
/// Declare any contexts that a server component will provide when it connects.
/// Any contexts named here will automatically provide the value `null` when the
/// `<lustre-server-component>` element is first rendered, preventing timing issues
/// related to slotted content with context subscriptions.
/// 
pub fn provides(names: List(String)) -> Attribute(message) {
  attribute("provides", string.join(names, " "))
}
